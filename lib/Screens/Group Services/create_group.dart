...
class CreateGroup extends StatefulWidget {
  ...
  const CreateGroup({Key? key,required this.latitudeCreate, required this.longitudeCreate}) : super(key: key);
...
class _CreateGroupState extends State<CreateGroup> {
  ...
  Future<void> createdLocation() async {
    ...
    await placemarkFromCoordinates(widget.latitudeCreate,widget.longitudeCreate);
      ...
      SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text(widget.latitudeCreate.toString()),
            Text(widget.longitudeCreate.toString()),
