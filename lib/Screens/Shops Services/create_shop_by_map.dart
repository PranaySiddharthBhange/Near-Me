...
class CreateShopByMap extends StatefulWidget {
  final String CollectionREf;
  final double latitudeCreate;
  final double longitudeCreate;
  const CreateShopByMap({Key? key,required this.CollectionREf, required this.latitudeCreate, required this.longitudeCreate}) : super(key: key);

  @override
  State<CreateShopByMap> createState() => _CreateShopByMapState();
}

class _CreateShopByMapState extends State<CreateShopByMap> {
