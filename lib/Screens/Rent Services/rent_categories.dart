...
class LeaseCategories extends StatefulWidget {
  const LeaseCategories({Key? key}) : super(key: key);

  @override
  State<LeaseCategories> createState() => _LeaseCategoriesState();
}

class _LeaseCategoriesState extends State<LeaseCategories> {
  ...
  void fetchCategories() async {
    try {
      final snapshot =
      await FirebaseFirestore.instance.collection('lease').get();
